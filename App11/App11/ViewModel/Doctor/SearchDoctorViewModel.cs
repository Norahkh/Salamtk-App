...
{
    class SearchDoctorViewModel : ContentPage, INotifyPropertyChanged
    {
        ...
        /*    public async Task test()
        {
          ...
          int hhh = (int)Application.Current.Properties["hosid"];

        var iii = await service.GetHospitalRate(hhh);
            ...
            foreach (var h in iii)
            {
                ...
                {
                    case 1:
                        Application.Current.Properties["y1"] = h.CountYes.ToString();
                        Application.Current.Properties["n1"] = h.CountNo.ToString();
                        Application.Current.Properties["m1"] = h.quis;
                        break;
                    case 2:
                        Application.Current.Properties["y2"] = h.CountYes;
    ...
    */
        public async Task<List<doctor>> SearchDoctor(string search)
        {

            DataService service = new DataService();

            List<doctor> hos = await service.SearchDoctor(search);
